...
หน้านี้สรุปเทคโนโลยีของระบบ Legal ERP และบริการที่ต้องเลือกก่อนเปิดใช้งานจริง
ระบบใช้ Google Cloud Platform เป็น Cloud Platform หลัก

## System Overview

<div aria-label="Technology stack system overview" style={{ overflowX: 'auto' }}>
...
| ความสามารถ               | การใช้งานใน Legal ERP                                                                          |
| :----------------------- | :--------------------------------------------------------------------------------------------- |
...
<div aria-label="Delivery flow" style={{ overflowX: 'auto' }}>
  <div style={{ minWidth: 720 }}>

```mermaid
flowchart LR
  GitHub["GitHub"] --> Actions["GitHub Actions<br/>Test and Build"]
...
- Marketing automation และ marketing analytics ไม่ใช่ส่วนของระบบ Legal ERP
