...
<div aria-label="Plan inheritance diagram" style={{ overflowX: 'auto' }}>
  <div style={{ minWidth: 720 }}>

```mermaid
flowchart LR
  Standard["STANDARD<br/>เริ่มต้นใช้งาน"]
  Essentials["ESSENTIALS<br/>ทำงานร่วมกัน"]
  Pro["PRO<br/>ควบคุมความเสี่ยงและเวลา"]
  Advanced["ADVANCED<br/>Billing และ HR"]
  Enterprise["ENTERPRISE<br/>Accounting และ Insight"]
...
<div aria-label="Plan change flow diagram" style={{ overflowX: 'auto' }}>
  <div style={{ minWidth: 720 }}>
