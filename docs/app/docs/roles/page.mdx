...
| --------- | ---------------------------------------------------- | ----------------------------------------------------------------------- |
| Admin     | Tenant Admin / ผู้ดูแลระบบขององค์กร                  | ตั้งค่าระบบ ผู้ใช้งาน role, permission, master data, security และ audit |
...
- Platform support ไม่ใช้ Admin role ของ Tenant และต้องผ่าน controlled
  service/support access หรือ Emergency Access ที่มีขอบเขตและเวลา
