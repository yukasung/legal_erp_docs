...
| Leave request            | พนักงาน (self-service) หรือ HR | Manager หรือ HR                    | บันทึกวันที่ลา ประเภทการลา และผู้อนุมัติ         |
| Payroll run              | HR                             | Manager หรือ Admin                 | บันทึกรอบเงินเดือน ผู้จัดทำ และผู้อนุมัติแยกกัน  |
