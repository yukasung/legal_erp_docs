...
| Manager   | เป็น Process Owner และอนุมัติ correction หรือ status maintenance เป็น A1                                       |
| Finance   | ตรวจ Retainer Plan, commercial document, usage และ financial term                                              |
| Admin     | อนุมัติรายการ identity/privacy/merge/compliance เป็น A2 หรือดำเนินการตามผลอนุมัติ โดยต้องแยกคนในรายการเดียวกัน |
...
- Exact identifier ที่ชนกันแต่ข้อมูลบุคคลไม่ตรง ต้องส่ง Admin
...
| แก้ identifier ที่ชนกับ Client อื่น   |     Lawyer/Assistant     |      Manager A1 + Admin A2       |         Admin         |
| Merge Client                          | Lawyer/Assistant/Manager |      Manager A1 + Admin A2       |         Admin         |
| Reverse Merge                         |         Manager          |      Manager A1 + Admin A2       |         Admin         |
| Deactivate                            |     Lawyer/Assistant     |             Manager              |         Admin         |
| Reactivate                            |     Lawyer/Assistant     |             Manager              |         Admin         |
| Reactivate ที่ถูกระงับด้วย compliance |         Manager          |      Manager A1 + Admin A2       |         Admin         |
...
- Client ที่ถูก deactivate ด้วย compliance ต้องใช้ Manager A1 และ Admin A2
...
| เปลี่ยน VIP criteria |     Manager      | Manager A1 + Admin A2 |         Admin         |
...
- Manager เข้าถึง Restricted record เมื่อมี compliance purpose และต้องมี access
  event
...
| ลด Restricted/Privileged                 |    Responsible Lawyer     |      Manager A1 + Admin A2       |         Admin         |
...
Admin A2 ใช้ classification metadata, reason และ approval evidence
...
- Disposal ต้องใช้ Manager A1 + Admin A2 อนุมัติร่วมก่อน Admin executor
  ดำเนินการและ สร้าง Destruction Certificate ตาม SOP-AUD-001
...
<div aria-label="Client registration workflow">
...
**Responsible:** Admin (Executor), Manager A1, Admin A2
...
- **Identifier ตรงแต่บุคคลไม่ตรง:** ส่ง Admin และห้ามสร้างต่อ
