...
| Manager               | เป็น Process Owner และอนุมัติหรือปฏิเสธงานระดับ Low/Medium             |
| Executive Approver    | อนุมัติ High risk เป็นลำดับสุดท้ายหลัง Manager                         |
| Alternate Approver    | อนุมัติแทนเมื่อ Manager หรือ Executive Approver ไม่อยู่                |
| Admin                 | เป็น System Owner ดูแล configuration, master data, RBAC และ Audit Log  |
| Data/Compliance Owner | อนุมัติการทำลายข้อมูลร่วมกับ Manager และกำกับ Legal Hold/Retention     |
...
flowchart TD
  ...
  Risk --> Accept{"Low/Medium: Manager<br/>High: Manager + Executive Approver"}
...
11. High risk ต้องให้ Manager อนุมัติลำดับแรกและ Executive Approver
    อนุมัติลำดับสุดท้าย
...
| High-risk approval   | ต้องมี Manager A1 และ Executive Approver A2                                  | A1/A2 approval records และหลักฐานประกอบ                            |
...
| Controlled disposal  | Manager และ Data/Compliance Owner อนุมัติร่วมก่อน Admin ดำเนินการ            | Dual approvals และ immutable Destruction Certificate               |
...
| Risk assessment: High       | 2 business days | Executive Approver                                  |
| Acceptance: Low/Medium      | 1 business day  | Manager และ Alternate Approver                      |
| Acceptance: High            | 2 business days | Executive Approver และ Alternate Executive Approver |
...
- **ต้อง Immediate Hold:** Responsible Lawyer หรือ Data/Compliance Owner สั่ง On
  Hold ได้ทันทีและให้ Manager review ภายใน 1 business day ห้าม resume อัตโนมัติ
...
- **มี Legal Hold:** ระงับ disposal จนกว่าจะมี released at แล้วคำนวณ eligibility
  ใหม่
- **ครบ Retention Period:** ตรวจ Legal Hold/dependency และใช้ Manager กับ
  Data/Compliance Owner อนุมัติร่วมก่อนให้ Admin ทำลาย
