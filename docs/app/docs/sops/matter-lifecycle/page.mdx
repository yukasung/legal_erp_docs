...
| High       | มีความเสี่ยงสำคัญ หลายปัจจัย หรืออาจกระทบองค์กร ต้องให้ Manager A1 และ Executive Approver A2 อนุมัติ |
...
| Activity                              | Lawyer | Assistant | Manager | Executive Approver | Admin |
| ------------------------------------- | ------ | --------- | ------- | ------------------ | ----- |
| ค้นหา/ลงทะเบียน Client                | C      | R         | A       | I                  | C     |
| เตรียมข้อมูล Matter intake            | R      | R         | A       | I                  | C     |
| ตรวจ conflict                         | R      | C         | A       | I                  | I     |
| ประเมิน risk                          | R      | C         | A       | I                  | I     |
| อนุมัติรับงาน Low/Medium              | C      | I         | A/R     | I                  | I     |
| อนุมัติรับงาน High                    | C      | I         | A1      | A2                 | I     |
| ลงทะเบียนและเชื่อม Client             | C      | R         | A       | I                  | C     |
| กำหนด Lawyer ผู้รับผิดชอบ             | C      | I         | A/R     | I                  | C     |
| เปลี่ยนเป็น Active                    | R      | R         | A       | I                  | I     |
| พักหรือเปิดงานต่อ                     | R      | I         | A       | I                  | I     |
| ยืนยันงานสาระสำคัญเสร็จ               | R      | C         | A       | I                  | I     |
| ปิดหรือเปิด Matter ใหม่               | R      | C         | A       | I                  | I     |
| ตั้งค่า status/permission/master data | I      | I         | C       | I                  | A/R   |
...
- Executive Approver เป็นผู้อนุมัติสุดท้าย (A2) โดยองค์กรแต่งตั้งจาก Managing
  Partner, Authorized Director หรือผู้บริหารที่มีอำนาจเทียบเท่า
- ผู้ประเมิน risk ต้องไม่เป็น Manager A1 หรือ Executive Approver A2
...
- ต้องกำหนด Alternate Executive Approver สำหรับกรณีผู้อนุมัติหลักไม่อยู่
...
| Pending Approval | Active           | High: Manager A1 และ Executive Approver A2 อนุมัติครบ, ผู้ประเมินไม่ใช่ A1/A2, Client/Lawyer เป็น active และ Commercial Readiness เป็น Accepted/Signed, Not Required หรือ Waived          | A1/A2 approval records, client/owner validation และ commercial evidence                       |
...
| Pending Approval | Active           | Lawyer/Assistant    | Low/Medium: Manager; High: Manager A1 + Executive A2    | System                 |
...
Responsible Lawyer หรือ Data/Compliance Owner สั่ง Immediate Hold ได้เมื่อมี
...
| Risk assessment: High       | 2 business days หลัง conflict cleared              | Executive Approver                                  |
| Acceptance: Low/Medium      | 1 business day หลัง assessment ครบ                 | Manager และ Alternate Approver                      |
| Acceptance: High            | 2 business days หลัง assessment และ mitigation ครบ | Executive Approver และ Alternate Executive Approver |
...
- Alternate Executive Approver และเหตุผลที่ใช้ เมื่อเกี่ยวข้อง
...
| DEC-MAT-004 | High risk ต้องมี Manager A1 และ Executive Approver A2 อนุมัติร่วมกัน และ Prohibited ห้าม override                       | Approved | 13 July 2026  |
...
- [x] ระบุ Manager A1 และ Executive Approver A2 สำหรับ High risk (DEC-MAT-004)
