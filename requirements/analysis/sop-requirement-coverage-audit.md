...
SOP ปัจจุบันครอบคลุม workflow หลักด้าน Client/Matter, Document,
...
## Resolved False-positive Coverage
...
รายการข้างต้นแก้แล้วโดย split `REQ-CLI-001`, จำกัด `REQ-SEC-001`, เพิ่ม
`REQ-CLI-004/005`, `REQ-INT-001/002`, `REQ-SEC-002/003`, `REQ-SUP-001/002`
และ `REQ-REP-002` พร้อม Decision, SOP/control, evidence และ UAT ที่สอดคล้องกัน
